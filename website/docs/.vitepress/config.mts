  ...
  '/guide/': [
    ...
    },
    {
      ...
      items: [
        ...
        { text: '7. 服务代码组织', link: '/guide/service-packages' },
        { text: '8. 权限按钮配置', link: '/guide/permission-button' },
    ...
    },
    {
      ...
      collapsed: false,
      items: [
        { text: '9. 测试指南', link: '/guide/testing' },
        { text: '10. 贡献指南', link: '/guide/contributing' },
  ...
  '/advanced/': [
    {
      ...
      items: [
        ...
        { text: '7. 调度演示', link: '/advanced/scheduled-demos' },
        { text: '8. SaaS 核对清单', link: '/advanced/saas' },
        { text: '9. 迁移策略', link: '/advanced/migration-strategy' },
        { text: '10. AI 模块提示词', link: '/advanced/ai-module' },
      ],
    },
  ],
  '/reference/': [
  ...
  '/en/guide/': [
    ...
    },
    {
      ...
      items: [
        ...
        { text: '7. Service code layout', link: '/en/guide/service-packages' },
        { text: '8. Permission buttons', link: '/en/guide/permission-button' },
    ...
    },
    {
      ...
      collapsed: false,
      items: [
        { text: '9. Testing', link: '/en/guide/testing' },
        { text: '10. Contributing', link: '/en/guide/contributing' },
  ...
  '/en/advanced/': [
    {
      ...
      items: [
        ...
        { text: '7. Schedule demos', link: '/en/advanced/scheduled-demos' },
        { text: '8. SaaS checklist', link: '/en/advanced/saas' },
        { text: '9. Migration strategy', link: '/en/advanced/migration-strategy' },
        { text: '10. AI module prompts', link: '/en/advanced/ai-module' },
      ],
    },
  ],
  '/en/reference/': [
