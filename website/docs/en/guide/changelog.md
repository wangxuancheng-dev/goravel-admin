...
> This page mirrors the Chinese documentation for accuracy. Switch language to **简体中文**, or open the [Chinese version](/guide/changelog).
...
- 🛠️ `platform:install` bootstrap；HTTP create forbids sync migrate；platform console async migrate/seed/backup (`tenant_ops`)
