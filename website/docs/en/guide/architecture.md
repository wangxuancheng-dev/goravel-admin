...
│   Ant Design 6 (primary)    │   Element Plus + vxe-table      │
├───────────────────────────────┴─────────────────────────────────┤
│                         Nginx / CDN                              │
├─────────────────────────────────────────────────────────────────┤
│                      Goravel API Server                          │
...
两套前端**对接同一 Admin API**，约定新功能同发。**React（`html-react/`）为默认前端**，Vue（`html/`）为对等参考实现；对齐清单见 [双前端对齐](/guide/frontend-parity)。架构上后端一份，前端双实现。
